...
class Wordle {
    static String GREEN = "\u001B[42m\u001B[30m";
    static String YELLOW = "\u001B[43m\u001B[30m";
    static String GRAY = "\u001B[47m\u001B[30m";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("With each guess, the letters change color to give you clues:");
        ...
        System.out.println("Gray: The letter is not in the word at all.");
