...
public class Rectangle {
    public static void main(String args[]) {
        ...
        if ((rect1[0] == rect1[2] && rect1[2] == rect1[4] && rect1[4] == rect1[6]) ||
                (rect1[1] == rect1[3] && rect1[3] == rect1[5] && rect1[5] == rect1[7])) {
            System.out.println("Invalid 1st rectangle");
            return;
        }
        ...
        if ((rect2[0] == rect2[2] && rect2[2] == rect2[4] && rect2[4] == rect2[6]) ||
                (rect2[1] == rect2[3] && rect2[3] == rect2[5] && rect2[5] == rect2[7])) {
            System.out.println("Invalid 2nd rectangle");
            return;
        }
